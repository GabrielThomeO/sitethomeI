  ...
  return (
    <div className="min-h-screen bg-thome-dark pt-11">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="mb-16">
          <img
            src="https://cdn.builder.io/api/v1/image/assets%2F4717588d46734d6f8b6837a8bbc277bb%2Fa1e1500146fd41aa8f65fa7251d60af7?format=webp&width=2400"
            alt="Projetos de Chalés"
        ...
        <div className="text-center">
          <p className="text-white font-vietnam text-2xl mb-8">
            Projetos sustentáveis de chalés que conectam arquitetura e natureza
          </p>
          <a
            href="/"
